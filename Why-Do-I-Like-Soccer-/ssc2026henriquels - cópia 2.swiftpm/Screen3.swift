...
struct Screen3: View {
    ...
    var body: some View {
        ZStack{
            ...
            VStack{
                TypeWriterTextView(text: "While growing up, soccer was very important to met several of my best friends, those I hope to keep for the rest of my life.", font: .title, isFinished: $showButtom, isSkipped: $textIsSkipped)
                    .padding()
